...
'''
LINK: https://www.youtube.com/watch?v=ML2w92TIzoA&list=PLjcN1EyupaQnHM1I9SmiXfbT6aG4ezUvu&index=5
'''
...
#load images
sun_img = pygame.image.load('files/images/sun.png')
sun_img = pygame.transform.scale(sun_img, (tile_size, tile_size))
bg_img = pygame.image.load('files/images/sky.png')
bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height - margin))
dirt_img = pygame.image.load('files/images/dirt.png')
grass_img = pygame.image.load('files/images/grass.png')
blob_img = pygame.image.load('files/images/blob.png')
platform_x_img = pygame.image.load('files/images/platform_x.png')
platform_y_img = pygame.image.load('files/images/platform_y.png')
lava_img = pygame.image.load('files/images/lava.png')
coin_img = pygame.image.load('files/images/coin.png')
exit_img = pygame.image.load('files/images/exit.png')
save_img = pygame.image.load('files/images/save_btn.png')
load_img = pygame.image.load('files/images/load_btn.png')
...
while run:
	...
	if save_button.draw():
		#save level data
		pickle_out = open(f'files/data/level{level}_data', 'wb')
